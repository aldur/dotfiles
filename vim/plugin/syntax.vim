...
autocmd vimrc WinEnter,VimEnter * if !exists('w:match_id_debug') |let w:match_id_debug = matchadd('Debug', '\zs\(XXX\|BUG\|DEBUG\|HACK\|WARNING\|WARN\)') | endif
autocmd vimrc WinEnter,VimEnter * if !exists('w:match_id_done') |let w:match_id_done = matchadd('Done', '\zs\(DONE\|FIXED\)') | endif
