function aldur#lsp#toggle_virtual_text() abort
    let l:lsp_vt = v:lua.require('aldur.lspconfig').virtual_text_enabled(bufnr("%"))
    ...
    lua require('aldur.lspconfig').reload_config()
endfunction

function aldur#lsp#toggle_signs() abort
    let l:lsp_signs = v:lua.require('aldur.lspconfig').signs_enabled(bufnr("%"))
...
function aldur#lsp#toggle_update_in_insert() abort
    let l:lsp_uii = v:lua.require('aldur.lspconfig').update_in_insert_enabled(bufnr("%"))
...
function aldur#lsp#toggle_underline() abort
    let l:lsp_underline_enabled = v:lua.require('aldur.lspconfig').underline_enabled(bufnr("%"))
